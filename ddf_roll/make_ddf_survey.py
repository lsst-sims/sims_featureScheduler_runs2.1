...
def optimize_ddf_times(ddf_name, ddf_RA, ddf_grid,
                       ...
                       roll_strengths=[1., 0.2, 1.8, 0.2, 1.8, 0.2, 1.8, 0.2, 1.8, 1., 1.]):
    ...
    for i, rs in enumerate(roll_strengths):
        in_season = np.where(round_season == i)
        raw_obs[in_season] *= raw_obs[in_season] * rs
