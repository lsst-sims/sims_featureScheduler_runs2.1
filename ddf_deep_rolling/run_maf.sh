...
#SBATCH --job-name=deep_rolling2.1
...
#SBATCH --chdir=/gscratch/scrubbed/yoachim/sims_featureScheduler_runs2.1/ddf_deep_rolling
...
cd /gscratch/scrubbed/yoachim/sims_featureScheduler_runs2.1/ddf_deep_rolling
