...
def ddf_surveys(detailers=None, season_frac=0.2, f1=0.6, f2=0.7):

    N1 = {}
    N2 = {}
    N1[0.7] = [1, 2, 9, 20, 29, 7]
    N1[0.75] = [1, 2, 9, 26, 35, 16]
    N1[0.8] = [1, 2, 9, 37, 52, 21]
    N2[0.6] = [1, 2, 9, 1, 1]

    obs_array = generate_ddf_scheduled_obs(nvis_master1=N1[f2], nvis_master2=N2[f1],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--f1", type=float, default=0.6)
    parser.add_argument("--f2", type=float, default=0.7)
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    file_end = 'slf%.2f_f1%.2f_f2%.2f_v2.1_' % (ddf_season_frac, f1, f2)
    ...
    ddfs = ddf_surveys(detailers=details, season_frac=ddf_season_frac, f1=f1, f2=f2)
