...
def generate_blobs(nside, nexp=2, exptime=30., filter1s=['u', 'u', 'g', 'r', 'i', 'z', 'y'],
    ...
    blob_survey_params = {'slew_approx': 7.5, 'filter_change_approx': 140.,
                          ...
                          'alt_max': 85., 'az_range': 180., 'flush_time': 30.,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--field_selection", type=int, default=1)
    ...
    dbroot = args.dbroot
    gsw = args.gsw
    field_selection = args.field_selection
